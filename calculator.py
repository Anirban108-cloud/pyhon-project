...
label_equal = Button(text="=", padx=40, pady=20, bg="Powder Blue", width=9, command=lambda: buttonequal())
...
label_clear = Button(text="C", font=15, padx=35.4, pady=17, bg="Powder Blue", command=lambda: buttonclear())
label_square = Button(text="Sq", padx=36, pady=20, bg="Powder Blue", command=lambda: buttonsquare())
label_squareroot = Button(text="Sqrt", padx=32, pady=20, bg="Powder Blue", command=lambda: buttonsquareroot())
label_dot = Button(text=".", padx=41, pady=52, bg="Powder Blue", command=lambda: buttondot())
